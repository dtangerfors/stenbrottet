  ...
  return (
    <main className="relative w-full h-dvh flex max-md:flex-col justify-end bg-surface">
      <figure className="absolute inset-0 w-full h-dvh">
        ...
        <div className="absolute inset-0 w-full h-dvh bg-overlay opacity-10"></div>
      </figure>
      ...
      <div className="relative md:h-full w-full lg:max-w-screen-sm flex flex-col justify-center items-center bg-surface max-md:self-end max-md:rounded-t-2xl max-md:pb-12 md:rounded-l-2xl transition-all duration-500">
        {children}
      </div>
    </main>
  );
