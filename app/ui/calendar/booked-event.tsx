  ...
  return (
    <div className="flex gap-1" title={`Klicka för att expandera ${booking.title}s bokning`}>
      ...
      <div style={{backgroundColor: `${booking.user_color}33`}} className="flex flex-col grow py-1 px-2 rounded-sm rounded-r-lg">
        ...
        <p className="font-sans font-normal text-primary-900 dark:text-primary-100">{showNiceDates(booking.travel_dates)} • {showGuests(booking.guests, booking.guestsChildren).total} • {getRoomName(booking.rooms)}</p>
